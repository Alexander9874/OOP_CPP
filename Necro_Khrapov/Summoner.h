...
{
    public:
		Summoner_Alive(int mh, int h, fraction_states f, int d, int dp, int sp = 10) :
...
{
    public:
		Summoner_Dead(int mh, int h, fraction_states f, int d, int dp, int sp, dead_states ds = GHOST) :
